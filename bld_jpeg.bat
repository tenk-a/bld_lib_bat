...
call :gen_header_jpeglib %CcLibJpegDir% >%CcMiscIncDir%\jpeglib.h.official
if not exist %CcMiscIncDir%\jpeglib.h copy %CcMiscIncDir%\jpeglib.h.official %CcMiscIncDir%\jpeglib.h
